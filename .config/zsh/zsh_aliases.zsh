...
alias 'dec2bin'='awk '"'"'{ printf "obase=2;%s\n", $0 }'"'"' | bc'
alias 'im-copy'='read url && curl "${url}" --output - | xclip -i -t image/$(printf "%s" "${url}" | tail -c 3)'
alias 'dd'='dd status=progress'
alias 'paccache-serve'='sudo -u http darkhttpd /var/cache/pacman/pkg --no-server-id'
